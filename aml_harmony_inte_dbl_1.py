...
sc.settings.figdir = '/home/big/zheng_song/aml_python/com_s15_rerun/figs/harmony/b_2'
...
adata = adata_all[adata_all.obs['anno_total'].isin(['Doublets_1', 'Doublets_2', 'Doublets_3'])].copy()
...
#adata.write(wd + 'all_cells_h5ad/b_cells_id_corrected_meta_data_raw_counts_harmony_re_clean.h5ad')

#print("running sc.pp.scrublet(adata, batch_key='sample', verbose = True)")

#sc.pp.scrublet(adata, batch_key='sample', verbose = True)
...
adata.write(wd + 'all_cells_h5ad/dbl_id_corrected_meta_data_raw_counts_harmony_scaled.h5ad')

# pca
sc.pp.pca(adata, n_comps=50)
sc.external.pp.harmony_integrate(adata, key=['sample', 'donor'], adjusted_basis = 'X_pca_harmony')
#adata = adata.raw.to_adata()
adata.write(wd + 'all_cells_h5ad/dbl_id_corrected_meta_data_raw_counts_harmony_re_clean_re_harmony.h5ad')
...
adata.write(wd + 'all_cells_h5ad/dbl_id_corrected_meta_data_raw_counts_harmony_re_clean_re_harmony_leiden.h5ad')