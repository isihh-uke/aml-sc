...
sc.settings.set_figure_params(dpi=100, 
                              ...
                              transparent=True)
sc.settings.figdir = '/path/to/your/fig'
...
# subset nk part
adata_nk = adata_all[adata_all.obs['anno_total'] == 'NK cells']
# read adata_nk_1 which was mixed with t cells
adata_nk_1 = sc.read_h5ad(wd + 'nk_1.h5ad')
# merge two nk adata in to one
adata_nk_total = sc.concat([adata_nk, adata_nk_1], join='inner')

adata = adata_nk_total.copy()
