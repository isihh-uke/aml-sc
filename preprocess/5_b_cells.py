...
sc.settings.figdir = '/path/to/your/fig/b'
...
adata = adata_all[adata_all.obs['anno_total'].isin(['B cells'])].copy()
...
adata.write(wd + 'all_cells_h5ad/b_cells_id_corrected_meta_data_raw_counts_harmony_scaled.h5ad')
